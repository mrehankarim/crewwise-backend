...
import {
    ...
    removePartFromWorkOrder, addAttachmentToWorkOrder,
    getOrganizationWorkOrders, getWorkOrderStats,
...
router.route("/").post(isLoggedIn, isSubscribed, isManagerOrSub, createWorkOrder);
